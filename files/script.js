...
function getPotionTransactionState(transaction) {
  ...
  const promoMaxUses = promotion && Number.isFinite(promotion.maxUses)
    ...
    : 0;
  const promoHasCheckout = Boolean(promotion && typeof promotion.checkoutUrl === "string");
  const promoInstantFulfillment = Boolean(promotion && promotion.instantFulfillment);
...
let rollCount = Math.max(storedRollCount, storedRollCount1);
let rollCount1 = rollCount;

function syncRollCounts() {
  rollCount1 = rollCount;
}

function setRollCounts(nextCount) {
  const parsed = Math.max(0, Math.trunc(Number(nextCount)));
  rollCount = Number.isFinite(parsed) ? parsed : 0;
  syncRollCounts();
}

function incrementRollCounts(increment = 1) {
  const parsed = Math.max(0, Math.trunc(Number(increment)));
  if (!Number.isFinite(parsed) || parsed <= 0) {
    syncRollCounts();
    return;
  }
...
function playOverlappingRollAudio(audio, basePlay = null) {
  ...
  clone.dataset.rollOverlapClone = "true";
  clone.volume = audio.volume;
  clone.muted = audio.muted;
  clone.preload = "auto";
  clone.currentTime = 0;

  document.body.appendChild(clone);

  const playAttempt = clone.play();
  const finalize = () => {
  ...
  clone.addEventListener("pause", finalize, { once: true });
...
function enableRollAudioOverlap() {
  ROLL_AUDIO_IDS.forEach((id) => {
    const audio = getAudioElement(id);
    if (!audio || audio.dataset.rollOverlapEnabled === "true") {
      return;
    }

    audio.dataset.rollOverlapEnabled = "true";
...
const rarityCategories = {
  ...
  under10k: [
    ...
    "astredBgImg",
    "isekailofiBgImg",
    "under10kfootstepBgImg",
    "under10kmurmurBgImg",
    "under10kraindropBgImg",
    "under10kwillowBgImg",
    "under10kemberBgImg",
    "under10ktangleBgImg",
    "under10kdrizzleBgImg",
  ...
  under100k: [
    ...
    "hypernovaBgImg",
    "mythicwallBgImg",
    "under100khearthBgImg",
    "under100klanewayBgImg",
    "under100kpollenBgImg",
    "under100ksundialBgImg",
    "under100kbrookBgImg",
    "under100kbrackenBgImg",
    "under100khollowBgImg",
    "under100kthicketBgImg",
    "under100kfableBgImg",
    "under100kcavernBgImg",
    "under100ktimberBgImg",
    "under100kharborBgImg",
    "under100kgroveBgImg",
    "under100kechoesBgImg",
    "under100klanternlightBgImg",
    "under100kashfallBgImg",
    "under100kwanderBgImg",
    "under100kcompassBgImg",
    "under100kdriftwoodBgImg",
    "under100kfireflyBgImg",
    "under100kgraniteBgImg",
    "under100kmistfallBgImg",
    "under100kwayfarerBgImg",
  ...
  under1m: [
    ...
    "mastermindBgImg",
    "alienBgImg",
    "under1mcrosswindBgImg",
    "under1mrustleBgImg",
    "under1mfootprintBgImg",
    "under1mwildwoodBgImg",
    "under1movergrowthBgImg",
    "under1mstonewallBgImg",
    "under1mmoonriseBgImg",
    "under1mseaboundBgImg",
    "under1mridgewayBgImg",
    "under1mduststormBgImg",
    "under1mnorthwindBgImg",
    "under1msunstoneBgImg",
    "under1mwellspringBgImg",
    "under1mdeepwaterBgImg",
    "under1mskylineBgImg",
    "under1mironwoodBgImg",
    "under1mwildfireBgImg",
    "under1mhighlandBgImg",
    "under1mnightfallBgImg",
    "under1mthunderBgImg",
    "under1mshorelineBgImg",
    "under1mmarinerBgImg",
    "under1mevergreenBgImg",
  ...
  transcendent: [
    ...
    "h1diBgImg",
    "equinoxBgImg",
    "under10mheadstoneBgImg",
    "under10mredwoodBgImg",
    "under10mmonsoonBgImg",
    "under10msandstormBgImg",
    "under10mhinterlandBgImg",
    "under10mblizzardBgImg",
    "under10mstonegateBgImg",
    "under10mwildlandsBgImg",
    "under10mtidefallBgImg",
    "under10mgoldleafBgImg",
    "under10mravenwoodBgImg",
    "under10mstormfrontBgImg",
    "under10mironcladBgImg",
    "under10mfrostbiteBgImg",
    "under10mshadowfallBgImg",
    "under10msunbreakBgImg",
    "under10mwindwardBgImg",
    "under10mearthboundBgImg",
    "under10mhighwaterBgImg",
    "under10mgraveyardBgImg",
    "under10mblackridgeBgImg",
    "under10mlongwinterBgImg",
    "under10mnorthstarBgImg",
    "under10mfirestormBgImg",
    "under10mdreadwoodBgImg",
    "under10mstoneheartBgImg",
    "under10mlastlightBgImg",
    "under10mdeadwindBgImg",
    "under10mfinalhourBgImg",
    "under10mworldendBgImg",
...
const ACHIEVEMENTS = [
  ...
  { name: "Befriended", requiredTitle: "Qbear : Xbear [1 in 213,330]", requiredRarityClass: "xbearBgImg" },
  { name: "Comeback", requiredTitle: "Qbear [1 in 35,555]", requiredRarityClass: "qbearBgImg" },
  { name: "Space Time Traveler", requiredTitle: "O R B I T A L [1 in 1,738,000]", requiredRarityClass: "orbitalBgImg" },
...
function stopAllAudio(options = {}) {
  const overlappingRollAudio = document.querySelectorAll("audio[data-roll-overlap-clone=\"true\"]");
  overlappingRollAudio.forEach((audio) => {
...
function registerRollButtonHandler() {
  ...
  if (
    ...
    rarity.type === "Qbear : Xbear [1 in 213,330]" ||
    ...
    if (rarity.type === "Fright [1 in 1,075]") {
    ...
    } else if (rarity.type === "Qbear : Xbear [1 in 213,330]") {
      hugeSuspenceAudio.play();
      ...
      hugeSuspenceAudio.play();
    } else if (rarity.type === "O R B I T A L [1 in 1,738,000]") {
      hugeSuspenceAudio.play();
...
function rollRarity() {
  ...
  const rarities = [
    ...
    {
      type: "Qbear : Xbear [1 in 213,330]",
      class: "xbearBgImg",
      chance: 0.00140627197,
      titles: ["Xbear", "Chosen Qbear", "Q", "QQ"],
    },
    {
      type: "O R B I T A L [1 in 1,738,000]",
      class: "orbitalBgImg",
      chance: 0.00005753739,
      titles: ["Crispy", "Orbs", "Pads"],
    },
    {
      type: "Pebble [1 in 186]",
      class: "under1kpebbleBgImg",
      chance: 0.005376344086,
      titles: ["Pebble I", "Pebble II", "Pebble III"],
    },
    {
      type: "Cinder [1 in 243]",
      class: "under1kcinderBgImg",
      chance: 0.004115226337,
      titles: ["Cinder I", "Cinder II", "Cinder III"],
    },
    {
      type: "Breeze [1 in 317]",
      class: "under1kbreezeBgImg",
      chance: 0.003154574132,
      titles: ["Breeze I", "Breeze II", "Breeze III"],
    },
    {
      type: "Dewdrop [1 in 404]",
      class: "under1kdewdropBgImg",
      chance: 0.002475247525,
      titles: ["Dewdrop I", "Dewdrop II", "Dewdrop III"],
    },
    {
      type: "Lantern [1 in 512]",
      class: "under1klanternBgImg",
      chance: 0.001953125000,
      titles: ["Lantern I", "Lantern II", "Lantern III"],
    },
    {
      type: "Meadow [1 in 777]",
      class: "under1kmeadowBgImg",
      chance: 0.001287001287,
      titles: ["Meadow I", "Meadow II", "Meadow III"],
    },
    {
      type: "Kindling [1 in 999]",
      class: "under1kkindlingBgImg",
      chance: 0.001001001001,
      titles: ["Kindling I", "Kindling II", "Kindling III"],
    },
    {
      type: "Footstep [1 in 1,203]",
      class: "under10kfootstepBgImg",
      chance: 0.000831255195,
      titles: ["Footstep I", "Footstep II", "Footstep III"],
    },
    {
      type: "Murmur [1 in 2,020]",
      class: "under10kmurmurBgImg",
      chance: 0.000495049505,
      titles: ["Murmur I", "Murmur II", "Murmur III"],
    },
    {
      type: "Raindrop [1 in 3,333]",
      class: "under10kraindropBgImg",
      chance: 0.000300030003,
      titles: ["Raindrop I", "Raindrop II", "Raindrop III"],
    },
    {
      type: "Willow [1 in 4,096]",
      class: "under10kwillowBgImg",
      chance: 0.000244140625,
      titles: ["Willow I", "Willow II", "Willow III"],
    },
    {
      type: "Ember [1 in 5,005]",
      class: "under10kemberBgImg",
      chance: 0.000199800200,
      titles: ["Ember I", "Ember II", "Ember III"],
    },
    {
      type: "Tangle [1 in 6,789]",
      class: "under10ktangleBgImg",
      chance: 0.000147297098,
      titles: ["Tangle I", "Tangle II", "Tangle III"],
    },
    {
      type: "Drizzle [1 in 8,080]",
      class: "under10kdrizzleBgImg",
      chance: 0.000123762376,
      titles: ["Drizzle I", "Drizzle II", "Drizzle III"],
    },
    {
      type: "Hearth [1 in 10,001]",
      class: "under100khearthBgImg",
      chance: 0.000099990001,
      titles: ["Hearth I", "Hearth II", "Hearth III"],
    },
    {
      type: "Laneway [1 in 12,121]",
      class: "under100klanewayBgImg",
      chance: 0.000082501444,
      titles: ["Laneway I", "Laneway II", "Laneway III"],
    },
    {
      type: "Pollen [1 in 15,015]",
      class: "under100kpollenBgImg",
      chance: 0.000066600067,
      titles: ["Pollen I", "Pollen II", "Pollen III"],
    },
    {
      type: "Sundial [1 in 16,384]",
      class: "under100ksundialBgImg",
      chance: 0.000061035156,
      titles: ["Sundial I", "Sundial II", "Sundial III"],
    },
    {
      type: "Brook [1 in 20,002]",
      class: "under100kbrookBgImg",
      chance: 0.000049995000,
      titles: ["Brook I", "Brook II", "Brook III"],
    },
    {
      type: "Bracken [1 in 22,222]",
      class: "under100kbrackenBgImg",
      chance: 0.000045000450,
      titles: ["Bracken I", "Bracken II", "Bracken III"],
    },
    {
      type: "Hollow [1 in 24,680]",
      class: "under100khollowBgImg",
      chance: 0.000040518639,
      titles: ["Hollow I", "Hollow II", "Hollow III"],
    },
    {
      type: "Thicket [1 in 27,382]",
      class: "under100kthicketBgImg",
      chance: 0.000036520342,
      titles: ["Thicket I", "Thicket II", "Thicket III"],
    },
    {
      type: "Fable [1 in 30,003]",
      class: "under100kfableBgImg",
      chance: 0.000033330000,
      titles: ["Fable I", "Fable II", "Fable III"],
    },
    {
      type: "Cavern [1 in 33,333]",
      class: "under100kcavernBgImg",
      chance: 0.000030000300,
      titles: ["Cavern I", "Cavern II", "Cavern III"],
    },
    {
      type: "Timber [1 in 36,036]",
      class: "under100ktimberBgImg",
      chance: 0.000027750028,
      titles: ["Timber I", "Timber II", "Timber III"],
    },
    {
      type: "Harbor [1 in 40,004]",
      class: "under100kharborBgImg",
      chance: 0.000024997500,
      titles: ["Harbor I", "Harbor II", "Harbor III"],
    },
    {
      type: "Grove [1 in 44,444]",
      class: "under100kgroveBgImg",
      chance: 0.000022500225,
      titles: ["Grove I", "Grove II", "Grove III"],
    },
    {
      type: "Echoes [1 in 48,048]",
      class: "under100kechoesBgImg",
      chance: 0.000020812521,
      titles: ["Echoes I", "Echoes II", "Echoes III"],
    },
    {
      type: "Lanternlight [1 in 50,505]",
      class: "under100klanternlightBgImg",
      chance: 0.000019800020,
      titles: ["Lanternlight I", "Lanternlight II", "Lanternlight III"],
    },
    {
      type: "Ashfall [1 in 55,555]",
      class: "under100kashfallBgImg",
      chance: 0.000018000180,
      titles: ["Ashfall I", "Ashfall II", "Ashfall III"],
    },
    {
      type: "Wander [1 in 60,006]",
      class: "under100kwanderBgImg",
      chance: 0.000016665000,
      titles: ["Wander I", "Wander II", "Wander III"],
    },
    {
      type: "Compass [1 in 65,065]",
      class: "under100kcompassBgImg",
      chance: 0.000015369246,
      titles: ["Compass I", "Compass II", "Compass III"],
    },
    {
      type: "Driftwood [1 in 70,007]",
      class: "under100kdriftwoodBgImg",
      chance: 0.000014284286,
      titles: ["Driftwood I", "Driftwood II", "Driftwood III"],
    },
    {
      type: "Firefly [1 in 75,075]",
      class: "under100kfireflyBgImg",
      chance: 0.000013320013,
      titles: ["Firefly I", "Firefly II", "Firefly III"],
    },
    {
      type: "Granite [1 in 80,808]",
      class: "under100kgraniteBgImg",
      chance: 0.000012375012,
      titles: ["Granite I", "Granite II", "Granite III"],
    },
    {
      type: "Mistfall [1 in 88,888]",
      class: "under100kmistfallBgImg",
      chance: 0.000011250113,
      titles: ["Mistfall I", "Mistfall II", "Mistfall III"],
    },
    {
      type: "Wayfarer [1 in 99,999]",
      class: "under100kwayfarerBgImg",
      chance: 0.000010000100,
      titles: ["Wayfarer I", "Wayfarer II", "Wayfarer III"],
    },
    {
      type: "Crosswind [1 in 111,111]",
      class: "under1mcrosswindBgImg",
      chance: 0.000009000009,
      titles: ["Crosswind I", "Crosswind II", "Crosswind III"],
    },
    {
      type: "Rustle [1 in 123,321]",
      class: "under1mrustleBgImg",
      chance: 0.000008108919,
      titles: ["Rustle I", "Rustle II", "Rustle III"],
    },
    {
      type: "Footprint [1 in 135,791]",
      class: "under1mfootprintBgImg",
      chance: 0.000007364258,
      titles: ["Footprint I", "Footprint II", "Footprint III"],
    },
    {
      type: "Wildwood [1 in 160,160]",
      class: "under1mwildwoodBgImg",
      chance: 0.000006243756,
      titles: ["Wildwood I", "Wildwood II", "Wildwood III"],
    },
    {
      type: "Overgrowth [1 in 180,180]",
      class: "under1movergrowthBgImg",
      chance: 0.000005550006,
      titles: ["Overgrowth I", "Overgrowth II", "Overgrowth III"],
    },
    {
      type: "Stonewall [1 in 200,200]",
      class: "under1mstonewallBgImg",
      chance: 0.000004995005,
      titles: ["Stonewall I", "Stonewall II", "Stonewall III"],
    },
    {
      type: "Moonrise [1 in 222,222]",
      class: "under1mmoonriseBgImg",
      chance: 0.000004500005,
      titles: ["Moonrise I", "Moonrise II", "Moonrise III"],
    },
    {
      type: "Seabound [1 in 246,246]",
      class: "under1mseaboundBgImg",
      chance: 0.000004060980,
      titles: ["Seabound I", "Seabound II", "Seabound III"],
    },
    {
      type: "Ridgeway [1 in 270,270]",
      class: "under1mridgewayBgImg",
      chance: 0.000003700004,
      titles: ["Ridgeway I", "Ridgeway II", "Ridgeway III"],
    },
    {
      type: "Duststorm [1 in 300,300]",
      class: "under1mduststormBgImg",
      chance: 0.000003330003,
      titles: ["Duststorm I", "Duststorm II", "Duststorm III"],
    },
    {
      type: "Northwind [1 in 333,333]",
      class: "under1mnorthwindBgImg",
      chance: 0.000003000003,
      titles: ["Northwind I", "Northwind II", "Northwind III"],
    },
    {
      type: "Sunstone [1 in 360,360]",
      class: "under1msunstoneBgImg",
      chance: 0.000002775003,
      titles: ["Sunstone I", "Sunstone II", "Sunstone III"],
    },
    {
      type: "Wellspring [1 in 400,400]",
      class: "under1mwellspringBgImg",
      chance: 0.000002497502,
      titles: ["Wellspring I", "Wellspring II", "Wellspring III"],
    },
    {
      type: "Deepwater [1 in 444,444]",
      class: "under1mdeepwaterBgImg",
      chance: 0.000002250002,
      titles: ["Deepwater I", "Deepwater II", "Deepwater III"],
    },
    {
      type: "Skyline [1 in 500,500]",
      class: "under1mskylineBgImg",
      chance: 0.000001998002,
      titles: ["Skyline I", "Skyline II", "Skyline III"],
    },
    {
      type: "Ironwood [1 in 555,555]",
      class: "under1mironwoodBgImg",
      chance: 0.000001800002,
      titles: ["Ironwood I", "Ironwood II", "Ironwood III"],
    },
    {
      type: "Wildfire [1 in 600,600]",
      class: "under1mwildfireBgImg",
      chance: 0.000001665002,
      titles: ["Wildfire I", "Wildfire II", "Wildfire III"],
    },
    {
      type: "Highland [1 in 650,650]",
      class: "under1mhighlandBgImg",
      chance: 0.000001536925,
      titles: ["Highland I", "Highland II", "Highland III"],
    },
    {
      type: "Nightfall [1 in 700,700]",
      class: "under1mnightfallBgImg",
      chance: 0.000001427144,
      titles: ["Nightfall I", "Nightfall II", "Nightfall III"],
    },
    {
      type: "Thunder [1 in 750,750]",
      class: "under1mthunderBgImg",
      chance: 0.000001332001,
      titles: ["Thunder I", "Thunder II", "Thunder III"],
    },
    {
      type: "Shoreline [1 in 800,800]",
      class: "under1mshorelineBgImg",
      chance: 0.000001248751,
      titles: ["Shoreline I", "Shoreline II", "Shoreline III"],
    },
    {
      type: "Mariner [1 in 888,888]",
      class: "under1mmarinerBgImg",
      chance: 0.000001125001,
      titles: ["Mariner I", "Mariner II", "Mariner III"],
    },
    {
      type: "Evergreen [1 in 999,999]",
      class: "under1mevergreenBgImg",
      chance: 0.000001000001,
      titles: ["Evergreen I", "Evergreen II", "Evergreen III"],
    },
    {
      type: "Headstone [1 in 1,200,000]",
      class: "under10mheadstoneBgImg",
      chance: 0.000000833333,
      titles: ["Headstone I", "Headstone II", "Headstone III"],
    },
    {
      type: "Redwood [1 in 1,500,001]",
      class: "under10mredwoodBgImg",
      chance: 0.000000666666,
      titles: ["Redwood I", "Redwood II", "Redwood III"],
    },
    {
      type: "Monsoon [1 in 1,800,008]",
      class: "under10mmonsoonBgImg",
      chance: 0.000000555553,
      titles: ["Monsoon I", "Monsoon II", "Monsoon III"],
    },
    {
      type: "Sandstorm [1 in 2,100,007]",
      class: "under10msandstormBgImg",
      chance: 0.000000476189,
      titles: ["Sandstorm I", "Sandstorm II", "Sandstorm III"],
    },
    {
      type: "Hinterland [1 in 2,400,024]",
      class: "under10mhinterlandBgImg",
      chance: 0.000000416663,
      titles: ["Hinterland I", "Hinterland II", "Hinterland III"],
    },
    {
      type: "Blizzard [1 in 2,700,027]",
      class: "under10mblizzardBgImg",
      chance: 0.000000370367,
      titles: ["Blizzard I", "Blizzard II", "Blizzard III"],
    },
    {
      type: "Stonegate [1 in 3,000,030]",
      class: "under10mstonegateBgImg",
      chance: 0.000000333330,
      titles: ["Stonegate I", "Stonegate II", "Stonegate III"],
    },
    {
      type: "Wildlands [1 in 3,300,033]",
      class: "under10mwildlandsBgImg",
      chance: 0.000000303027,
      titles: ["Wildlands I", "Wildlands II", "Wildlands III"],
    },
    {
      type: "Tidefall [1 in 3,600,036]",
      class: "under10mtidefallBgImg",
      chance: 0.000000277775,
      titles: ["Tidefall I", "Tidefall II", "Tidefall III"],
    },
    {
      type: "Goldleaf [1 in 3,900,039]",
      class: "under10mgoldleafBgImg",
      chance: 0.000000256408,
      titles: ["Goldleaf I", "Goldleaf II", "Goldleaf III"],
    },
    {
      type: "Ravenwood [1 in 4,200,042]",
      class: "under10mravenwoodBgImg",
      chance: 0.000000238093,
      titles: ["Ravenwood I", "Ravenwood II", "Ravenwood III"],
    },
    {
      type: "Stormfront [1 in 4,500,045]",
      class: "under10mstormfrontBgImg",
      chance: 0.000000222220,
      titles: ["Stormfront I", "Stormfront II", "Stormfront III"],
    },
    {
      type: "Ironclad [1 in 4,800,048]",
      class: "under10mironcladBgImg",
      chance: 0.000000208331,
      titles: ["Ironclad I", "Ironclad II", "Ironclad III"],
    },
    {
      type: "Frostbite [1 in 5,100,051]",
      class: "under10mfrostbiteBgImg",
      chance: 0.000000196076,
      titles: ["Frostbite I", "Frostbite II", "Frostbite III"],
    },
    {
      type: "Shadowfall [1 in 5,400,054]",
      class: "under10mshadowfallBgImg",
      chance: 0.000000185183,
      titles: ["Shadowfall I", "Shadowfall II", "Shadowfall III"],
    },
    {
      type: "Sunbreak [1 in 5,700,057]",
      class: "under10msunbreakBgImg",
      chance: 0.000000175437,
      titles: ["Sunbreak I", "Sunbreak II", "Sunbreak III"],
    },
    {
      type: "Windward [1 in 6,000,060]",
      class: "under10mwindwardBgImg",
      chance: 0.000000166665,
      titles: ["Windward I", "Windward II", "Windward III"],
    },
    {
      type: "Earthbound [1 in 6,300,063]",
      class: "under10mearthboundBgImg",
      chance: 0.000000158729,
      titles: ["Earthbound I", "Earthbound II", "Earthbound III"],
    },
    {
      type: "Highwater [1 in 6,600,066]",
      class: "under10mhighwaterBgImg",
      chance: 0.000000151514,
      titles: ["Highwater I", "Highwater II", "Highwater III"],
    },
    {
      type: "Graveyard [1 in 6,900,069]",
      class: "under10mgraveyardBgImg",
      chance: 0.000000144926,
      titles: ["Graveyard I", "Graveyard II", "Graveyard III"],
    },
    {
      type: "Blackridge [1 in 7,200,072]",
      class: "under10mblackridgeBgImg",
      chance: 0.000000138888,
      titles: ["Blackridge I", "Blackridge II", "Blackridge III"],
    },
    {
      type: "Longwinter [1 in 7,350,073]",
      class: "under10mlongwinterBgImg",
      chance: 0.000000136053,
      titles: ["Longwinter I", "Longwinter II", "Longwinter III"],
    },
    {
      type: "Northstar [1 in 7,400,074]",
      class: "under10mnorthstarBgImg",
      chance: 0.000000135134,
      titles: ["Northstar I", "Northstar II", "Northstar III"],
    },
    {
      type: "Firestorm [1 in 7,450,074]",
      class: "under10mfirestormBgImg",
      chance: 0.000000134227,
      titles: ["Firestorm I", "Firestorm II", "Firestorm III"],
    },
    {
      type: "Dreadwood [1 in 7,480,074]",
      class: "under10mdreadwoodBgImg",
      chance: 0.000000133689,
      titles: ["Dreadwood I", "Dreadwood II", "Dreadwood III"],
    },
    {
      type: "Stoneheart [1 in 7,490,001]",
      class: "under10mstoneheartBgImg",
      chance: 0.000000133511,
      titles: ["Stoneheart I", "Stoneheart II", "Stoneheart III"],
    },
    {
      type: "Lastlight [1 in 7,495,005]",
      class: "under10mlastlightBgImg",
      chance: 0.000000133422,
      titles: ["Lastlight I", "Lastlight II", "Lastlight III"],
    },
    {
      type: "Deadwind [1 in 7,498,008]",
      class: "under10mdeadwindBgImg",
      chance: 0.000000133369,
      titles: ["Deadwind I", "Deadwind II", "Deadwind III"],
    },
    {
      type: "Finalhour [1 in 7,499,500]",
      class: "under10mfinalhourBgImg",
      chance: 0.000000133342,
      titles: ["Finalhour I", "Finalhour II", "Finalhour III"],
    },
    {
      type: "Worldend [1 in 75,000,000]",
      class: "under10mworldendBgImg",
      chance: 0.000000013333,
...
const backgroundDetails = {
  ...
  orbitalBgImg: { image: "files/backgrounds/orbital.png", audio: "orbitalAudio" },
  ...
  under1kpebbleBgImg: { image: "files/backgrounds/pebble.png", audio: null },
  under1kcinderBgImg: { image: "files/backgrounds/cinder.png", audio: null },
  under1kbreezeBgImg: { image: "files/backgrounds/breeze.png", audio: null },
  under1kdewdropBgImg: { image: "files/backgrounds/dewdrop.png", audio: null },
  under1klanternBgImg: { image: "files/backgrounds/lantern.png", audio: null },
  under1kmeadowBgImg: { image: "files/backgrounds/meadow.png", audio: null },
  under1kkindlingBgImg: { image: "files/backgrounds/kindling.png", audio: null },
  under10kfootstepBgImg: { image: "files/backgrounds/footstep.png", audio: "footstepAudio" },
  under10kmurmurBgImg: { image: "files/backgrounds/murmur.png", audio: "murmurAudio" },
  under10kraindropBgImg: { image: "files/backgrounds/raindrop.png", audio: "raindropAudio" },
  under10kwillowBgImg: { image: "files/backgrounds/willow.png", audio: "willowAudio" },
  under10kemberBgImg: { image: "files/backgrounds/ember.png", audio: "emberAudio" },
  under10ktangleBgImg: { image: "files/backgrounds/tangle.png", audio: "tangleAudio" },
  under10kdrizzleBgImg: { image: "files/backgrounds/drizzle.png", audio: "drizzleAudio" },
  under100khearthBgImg: { image: "files/backgrounds/hearth.png", audio: "hearthAudio" },
  under100klanewayBgImg: { image: "files/backgrounds/laneway.png", audio: "lanewayAudio" },
  under100kpollenBgImg: { image: "files/backgrounds/pollen.png", audio: "pollenAudio" },
  under100ksundialBgImg: { image: "files/backgrounds/sundial.png", audio: "sundialAudio" },
  under100kbrookBgImg: { image: "files/backgrounds/brook.png", audio: "brookAudio" },
  under100kbrackenBgImg: { image: "files/backgrounds/bracken.png", audio: "brackenAudio" },
  under100khollowBgImg: { image: "files/backgrounds/hollow.png", audio: "hollowAudio" },
  under100kthicketBgImg: { image: "files/backgrounds/thicket.png", audio: "thicketAudio" },
  under100kfableBgImg: { image: "files/backgrounds/fable.png", audio: "fableAudio" },
  under100kcavernBgImg: { image: "files/backgrounds/cavern.png", audio: "cavernAudio" },
  under100ktimberBgImg: { image: "files/backgrounds/timber.png", audio: "timberAudio" },
  under100kharborBgImg: { image: "files/backgrounds/harbor.png", audio: "harborAudio" },
  under100kgroveBgImg: { image: "files/backgrounds/grove.png", audio: "groveAudio" },
  under100kechoesBgImg: { image: "files/backgrounds/echoes.png", audio: "echoesAudio" },
  under100klanternlightBgImg: { image: "files/backgrounds/lanternlight.png", audio: "lanternlightAudio" },
  under100kashfallBgImg: { image: "files/backgrounds/ashfall.png", audio: "ashfallAudio" },
  under100kwanderBgImg: { image: "files/backgrounds/wander.png", audio: "wanderAudio" },
  under100kcompassBgImg: { image: "files/backgrounds/compass.png", audio: "compassAudio" },
  under100kdriftwoodBgImg: { image: "files/backgrounds/driftwood.png", audio: "driftwoodAudio" },
  under100kfireflyBgImg: { image: "files/backgrounds/firefly.png", audio: "fireflyAudio" },
  under100kgraniteBgImg: { image: "files/backgrounds/granite.png", audio: "graniteAudio" },
  under100kmistfallBgImg: { image: "files/backgrounds/mistfall.png", audio: "mistfallAudio" },
  under100kwayfarerBgImg: { image: "files/backgrounds/wayfarer.png", audio: "wayfarerAudio" },
  under1mcrosswindBgImg: { image: "files/backgrounds/crosswind.png", audio: "crosswindAudio" },
  under1mrustleBgImg: { image: "files/backgrounds/rustle.png", audio: "rustleAudio" },
  under1mfootprintBgImg: { image: "files/backgrounds/footprint.png", audio: "footprintAudio" },
  under1mwildwoodBgImg: { image: "files/backgrounds/wildwood.png", audio: "wildwoodAudio" },
  under1movergrowthBgImg: { image: "files/backgrounds/overgrowth.png", audio: "overgrowthAudio" },
  under1mstonewallBgImg: { image: "files/backgrounds/stonewall.png", audio: "stonewallAudio" },
  under1mmoonriseBgImg: { image: "files/backgrounds/moonrise.png", audio: "moonriseAudio" },
  under1mseaboundBgImg: { image: "files/backgrounds/seabound.png", audio: "seaboundAudio" },
  under1mridgewayBgImg: { image: "files/backgrounds/ridgeway.png", audio: "ridgewayAudio" },
  under1mduststormBgImg: { image: "files/backgrounds/duststorm.png", audio: "duststormAudio" },
  under1mnorthwindBgImg: { image: "files/backgrounds/northwind.png", audio: "northwindAudio" },
  under1msunstoneBgImg: { image: "files/backgrounds/sunstone.png", audio: "sunstoneAudio" },
  under1mwellspringBgImg: { image: "files/backgrounds/wellspring.png", audio: "wellspringAudio" },
  under1mdeepwaterBgImg: { image: "files/backgrounds/deepwater.png", audio: "deepwaterAudio" },
  under1mskylineBgImg: { image: "files/backgrounds/skyline.png", audio: "skylineAudio" },
  under1mironwoodBgImg: { image: "files/backgrounds/ironwood.png", audio: "ironwoodAudio" },
  under1mwildfireBgImg: { image: "files/backgrounds/wildfire.png", audio: "wildfireAudio" },
  under1mhighlandBgImg: { image: "files/backgrounds/highland.png", audio: "highlandAudio" },
  under1mnightfallBgImg: { image: "files/backgrounds/nightfall.png", audio: "nightfallAudio" },
  under1mthunderBgImg: { image: "files/backgrounds/thunder.png", audio: "thunderAudio" },
  under1mshorelineBgImg: { image: "files/backgrounds/shoreline.png", audio: "shorelineAudio" },
  under1mmarinerBgImg: { image: "files/backgrounds/mariner.png", audio: "marinerAudio" },
  under1mevergreenBgImg: { image: "files/backgrounds/evergreen.png", audio: "evergreenAudio" },
  under10mheadstoneBgImg: { image: "files/backgrounds/headstone.png", audio: "headstoneAudio" },
  under10mredwoodBgImg: { image: "files/backgrounds/redwood.png", audio: "redwoodAudio" },
  under10mmonsoonBgImg: { image: "files/backgrounds/monsoon.png", audio: "monsoonAudio" },
  under10msandstormBgImg: { image: "files/backgrounds/sandstorm.png", audio: "sandstormAudio" },
  under10mhinterlandBgImg: { image: "files/backgrounds/hinterland.png", audio: "hinterlandAudio" },
  under10mblizzardBgImg: { image: "files/backgrounds/blizzard.png", audio: "blizzardAudio" },
  under10mstonegateBgImg: { image: "files/backgrounds/stonegate.png", audio: "stonegateAudio" },
  under10mwildlandsBgImg: { image: "files/backgrounds/wildlands.png", audio: "wildlandsAudio" },
  under10mtidefallBgImg: { image: "files/backgrounds/tidefall.png", audio: "tidefallAudio" },
  under10mgoldleafBgImg: { image: "files/backgrounds/goldleaf.png", audio: "goldleafAudio" },
  under10mravenwoodBgImg: { image: "files/backgrounds/ravenwood.png", audio: "ravenwoodAudio" },
  under10mstormfrontBgImg: { image: "files/backgrounds/stormfront.png", audio: "stormfrontAudio" },
  under10mironcladBgImg: { image: "files/backgrounds/ironclad.png", audio: "ironcladAudio" },
  under10mfrostbiteBgImg: { image: "files/backgrounds/frostbite.png", audio: "frostbiteAudio" },
  under10mshadowfallBgImg: { image: "files/backgrounds/shadowfall.png", audio: "shadowfallAudio" },
  under10msunbreakBgImg: { image: "files/backgrounds/sunbreak.png", audio: "sunbreakAudio" },
  under10mwindwardBgImg: { image: "files/backgrounds/windward.png", audio: "windwardAudio" },
  under10mearthboundBgImg: { image: "files/backgrounds/earthbound.png", audio: "earthboundAudio" },
  under10mhighwaterBgImg: { image: "files/backgrounds/highwater.png", audio: "highwaterAudio" },
  under10mgraveyardBgImg: { image: "files/backgrounds/graveyard.png", audio: "graveyardAudio" },
  under10mblackridgeBgImg: { image: "files/backgrounds/blackridge.png", audio: "blackridgeAudio" },
  under10mlongwinterBgImg: { image: "files/backgrounds/longwinter.png", audio: "longwinterAudio" },
  under10mnorthstarBgImg: { image: "files/backgrounds/northstar.png", audio: "northstarAudio" },
  under10mfirestormBgImg: { image: "files/backgrounds/firestorm.png", audio: "firestormAudio" },
  under10mdreadwoodBgImg: { image: "files/backgrounds/dreadwood.png", audio: "dreadwoodAudio" },
  under10mstoneheartBgImg: { image: "files/backgrounds/stoneheart.png", audio: "stoneheartAudio" },
  under10mlastlightBgImg: { image: "files/backgrounds/lastlight.png", audio: "lastlightAudio" },
  under10mdeadwindBgImg: { image: "files/backgrounds/deadwind.png", audio: "deadwindAudio" },
  under10mfinalhourBgImg: { image: "files/backgrounds/finalhour.png", audio: "finalhourAudio" },
  under10mworldendBgImg: { image: "files/backgrounds/worldend.png", audio: "worldendAudio" },
};
...
function hasAutoRollLuckyPotion() {
  return AUTO_ROLL_REQUIRED_LUCKY_POTION_IDS.some((potionId) => getPotionCount(potionId) > 0);
}

function isAutoRollPermanentlyUnlocked() {
  return storage.get(AUTO_ROLL_PERMANENT_UNLOCK_KEY, false) === true;
}

function unlockAutoRollPermanently() {
...
function getClassForRarity(rarity) {
  const rarityClasses = {
      ...
      'Qbear : Xbear [1 in 213,330]': 'under100k',
...
document
  .getElementById("deleteAllOrbitalButton")
  .addEventListener("click", () => deleteAllByRarity("orbitalBgImg"));
document
  .getElementById("deleteAllXbearButton")
  .addEventListener("click", () => deleteAllByRarity("xbearlBgImg"));
